...
<head>
    ...
    <link rel="script" href="assets/js/AddToCart.js">
</head>
<body>
                        ...
                        <div data-bs-toggle="modal" data-bs-target="">
                            <div class="card shadow-lg" data-bs-hover-animate="pulse" style="width: 300px;height: 453px;border-radius: 20px;background-image: linear-gradient(to right,rgb(255,100,193), rgb(255,255,255));margin: 20px;">
                                <div class="card-body">
                                    ...
                                    <button class="btn btn-light text-center d-xl-flex mx-auto justify-content-xl-center"  type="button" style="margin-left: 0px;background-color: orange;color: rgb(255,255,255);" onclick="document.location = 'Cart.jsp'">Add To Cart</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div data-bs-toggle="modal" data-bs-target="">
                            <div class="card shadow-lg" data-bs-hover-animate="pulse" style="width: 300px;height: 453px;border-radius: 20px;background-image: linear-gradient(to right,rgb(255,100,193), rgb(255,255,255));margin: 20px;">
                                <div class="card-body">
                                    ...
                                    <button class="btn btn-light text-center d-xl-flex mx-auto justify-content-xl-center"  type="button" onclick="document.location = 'Cart2.jsp'" style="margin-left: 0px;background-color: orange;color: rgb(255,255,255);">Add To Cart</button>
                                </div>
                            </div>
                        </div>
                        <div data-bs-toggle="modal" data-bs-target="#DecorationDetails">
