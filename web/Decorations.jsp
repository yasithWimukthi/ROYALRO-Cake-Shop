                    ...
                    <div data-bs-toggle="modal" data-bs-target="#cakeDetails">
                        <div class="card shadow-lg" data-bs-hover-animate="pulse"
                            ...
                            <div class="card-body">
                                ...
                                <form action="AddToCartServlet" method="post" enctype="multipart/form-data" >
                                    ...
                                    <div class="form-group" style="float: right; margin-top: 10px">
                                        ...
                                        <input style="display: none" type="number" id="insertDecorationId" name="id" value="<%=decoration.getDecorationId()%>">
                                        <input style="display: none" type="text" id="insertDecorationName" name="name"  value="<%=decoration.getName()%>">
                                        <input style="display: none" type="text" id="insertDecorationPrice" name="price"  value="<%=decoration.getPrice()%>">
                                        <input style="display: none" type="text" id="insertDecorationImagePath" name="image"  value="<%=decoration.getImagePath()%>">

                                        <button class="btn btn-light text-center d-xl-flex mx-auto justify-content-xl-center"
                                                type="submit"
                                                style="margin-left: 0px;background-color: orange;color: rgb(255,255,255);" id="btn1">
                                            Add To Cart
                                        </button>
                                    </div>
                                </form>
                    ...
                    <div data-bs-toggle="modal" data-bs-target="#cakeDetails">
                        <div class="card shadow-lg" data-bs-hover-animate="pulse"
                            ...
                            <div class="card-body">
                                ...
                                <form action="AddToCartServlet" method="post" enctype="multipart/form-data" id="updateDecorationForm">


                                <div class="form-group" style="float: right; margin-top: 10px">

                                    <input style="display: none" type="number" id="insertBirthdayDecorationId" name="id" value="<%=decoration.getDecorationId()%>">
                                    <input style="display: none" type="text" id="insertBithdayDecorationName" name="name"  value="<%=decoration.getName()%>">
                                    <input style="display: none" type="text" id="insertBirthdayDecorationPrice" name="price"  value="<%=decoration.getPrice()%>">
                                    <input style="display: none" type="text" id="insertBirthdayDecorationImagePath" name="image"  value="<%=decoration.getImagePath()%>">
                                    <button class="btn btn-light text-center d-xl-flex mx-auto justify-content-xl-center"
                                            type="submit"
