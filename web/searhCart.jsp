...
<%
    ...
    ArrayList<Cart> searchList  = cartService.searchCartItemByName(key);
                        ...
                        <tr>
                            <td>
                                <div class="product-img">
                                    <div class="img-prdct">
                                        <img class="rounded" style="margin-left: 3px;width: 100px;height: 100px;" src="<%=cart.getImagePath()%>" width="150px" height="150px">

                                    </div>
                                </div>
                            </td>
                            <td>
                                <p style=" margin-top: 30px;margin-left: -20px"><%=cart.getName()%></p>
                            </td>
                            <td>
                            ...
                            <td>
                                <input name="price1" style="width: 100px;margin-top: 20px" type="text" value="<%=cart.getPrice()%>" class="price form-control"  disabled>
                            </td>
