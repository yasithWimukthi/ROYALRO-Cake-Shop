...
<div style="height: 500px;">
 ...
 --%>
                    ...
                    <table id="myTable" class="table">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-container">
                                    <button class="cart-qty-plus" type="button" value="+" style="margin-left: -25px;margin-top: 10px" id="plus">+</button>
                                    <input style="width: 40px" type="text" id="qty" min="3" class="qty form-control" value="3"/>
                        ...
                        <tr>
                            <td>
                                <div class="product-img">
                                    <div class="img-prdct">
                                        <img class="rounded" style="margin-left: 3px;width: 100px;height: 100px;" src="assets/img/MicrosoftTeams-image.png" width="150px" height="150px">

                                    </div>
                                </div>
                            </td>
                            <td>
                                <p style=" margin-top: 30px;margin-left: -20px">Kids Type Decoration</p>
                            </td>
                            <td>
                                <div class="button-container">
                                    <button class="cart-qty-plus" type="button" value="+" style="margin-left: -25px;margin-top: 10px">+</button>
                                    <input style="width: 40px" type="text" name="qty" min="1" class="qty form-control" value="1"/>
                                    <button style="margin-left: -22px" class="cart-qty-minus" type="button" value="-">-</button>
                                </div>
                            </td>

                            <td>
                                <input style="width: 100px;margin-top: 20px" type="text" value="35000" class="price form-control"  disabled>
                            </td>
            ...
            <div class="col-md-6 col-lg-4" style="background-image: linear-gradient(to right,rgb(255,100,193), rgb(255,255,255)); padding: 10px; padding-left:50px;border-radius: 10px">
                ...
                <hr>
                <div style="height: 50px;"><label style="width: 50px;margin-right: 23px">Price:</label><label style="width: 50px;margin-right: 15px;margin-left: 20px">LKR</label><label  class="price text-end" style="width: 80px;margin-right: 15px;">230000.00</label></div>
                <div style="height: 50px;"><label style="width: 80px;margin-right: 15px;">Delivery:</label><label style="width: 50px;margin-right: 15px;">LKR</label><label class="text-end" style="width: 80px;margin-right: 15px;">300.00</label></div>
                <hr>
                <div style="height: 50px;"><label style="width: 80px;margin-right: 15px;"><strong>Sub Total</strong></label><label style="width: 50px;margin-right: 15px;">LKR</label><label id="total" class="subtotal text-end total" style="width: 80px;margin-right: 15px;">230300.00</label></div>
