        ...
        <ul class="nav navbar-nav" style="width: 934px;margin: 30px;height: 11px;">
            ...
            <%
                ...
                if(type.equals("admin")){ %>
                    <li class="nav-item" role="presentation"><a class="nav-link" data-bs-hover-animate="jello" href="adminDashboard.jsp" style="font-family: 'Dancing Script', cursive;font-size: 25px;color: #af1e2d;width: 119px;">admin</a></li>
                <%}%>
        </ul>
