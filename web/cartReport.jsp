...
<div>
  ...
  <div style="margin-left: 10px;text-decoration: none; ">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="Cart.jsp" style="text-decoration: none;color: #5c636a;"><span>Item Management</span></a></li>
      <li class="breadcrumb-item"><a href="cartReport.jsp" style="text-decoration: none;color: #5c636a;"><span>Report Genaration</span></a></li>
    </ol>
  </div>
        ...
        <div class="content" style="padding-left: 56px;">
          ...
          <div class="shadow-lg" style="margin: 51px;background-color: #ffffff;border-radius: 20px;">
            <div style="padding: 22px;">
              <div id="printArea">
                <section>
                  <h2 class="text-center" style="padding: 14px;">ROYALRO CART ITEMS LIST</h2>
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped" id="tblData">
                      ...
                      <%
                        ...
                        List<Cart> itemsList = cs.getAllCartItems();
                        for(Cart item : itemsList) {
                      %>

                      <tr class="text-center">
                        <td class="text-left" ><%=item.getItemId()%></td>
              ...
              <section class="text-right">
                <div><button id="pdf" name="pdf" onclick="downloadPDF()" class="btn btn-primary text-xl-center" type="button" style="margin: 15px;background-color: #ff0000;width: 250px;">Download PDF<i class="fa fa-file-pdf-o" style="font-size: 24px;width: 177px;"></i></button>
                  <button id="excel" name="excel" onclick="downloadExcel('tblData', 'CartList')"class="btn btn-primary text-xl-center" type="button" style="margin: 15px;width: 250px;background-color: #008000;">Download Excel<i class="fa fa-file-excel-o" style="font-size: 24px;width: 177px;"></i></button></div>
              </section>
            </div>
          </div>
        </div>
