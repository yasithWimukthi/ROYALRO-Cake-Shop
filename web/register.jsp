        ...
        <div style="border-top-width: 0;">
            ...
            <form method="POST" action="SignUpServlet" id="signUpForm">
                <div class="input-group" style="margin: 0 auto;width: 80%;">
                    ...
                    <input id="name-input" class="form-control form-control" type="text" placeholder="Name" name="name">
                </div>
                ...
                <div class="input-group" style="margin: 0 auto;width: 80%;">
                    ...
                    <input id="email-input" class="form-control form-control" type="text" placeholder="E-mail" name="email">
                </div>
                ...
                <div class="input-group" style="margin: 0 auto;width: 80%;">
                    ...
                    <input id="mobile-input" class="form-control form-control" type="text" placeholder="Mobile Number" name="mobile" >
                </div>
                ...
                <div class="input-group" style="margin: 0 auto;width: 80%;">
                    ...
                    <input id="password-input" class="form-control form-control" type="text" placeholder="Password" onkeyup="onPasswordChange(this)"  name="password">
                </div>
