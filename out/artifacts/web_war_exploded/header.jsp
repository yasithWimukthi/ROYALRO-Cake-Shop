...
<nav class="navbar navbar-light navbar-expand-md navigation-clean-search" style="height: 100px;">
    <div class="collapse navbar-collapse text-right" id="navcol-2" style="padding: 8px 18px;width: 927px;height: 140px;color: rgb(81,19,29);">
        ...
        <ul class="nav navbar-nav" style="width: 934px;margin: 30px;height: 11px;">
            ...
            <li class="nav-item" role="presentation"><a class="nav-link" data-bs-hover-animate="jello" href="#" style="font-family: 'Dancing Script', cursive;font-size: 25px;color: #af1e2d;height: 57px;width: 121px;">Cakes</a></li>
            <li class="nav-item" role="presentation"><a class="nav-link" data-bs-hover-animate="jello" href="DecoView.jsp" style="font-family: 'Dancing Script', cursive;font-size: 25px;color: #af1e2d;width: 167px;">Decorations</a></li>
            ...
            <li class="nav-item" role="presentation" style="width: 150px;"><a class="nav-link" data-bs-hover-animate="jello" href="ContactUs.jsp" style="font-family: 'Dancing Script', cursive;font-size: 25px;color: #af1e2d;width: 139px;">Contact Us</a></li>
    ...
    <a href="Cart3.jsp" class="fa fa-shopping-cart shadow-none d-table-row ml-auto" style="font-size: 31px;filter: blur(0px) grayscale(0%);color: #51131d;opacity: 1;margin: 10px;" ></a>
    <a  href="Profile.jsp" class="fa fa-user-circle-o ml-auto" style="font-size: 31px;color: #521721;opacity: 1;margin: 5px; text-decoration: none"></a>
