...
<%@ page import="com.royalro.model.Decoration" %>
...
<body>
<%
    DecorationService cakeService = new DecorationService();
    String key = request.getParameter("key");
    ArrayList<Decoration> weddingDecorations = cakeService.searchDecorationByCategoryAndName(key,"Wedding Decorations");
    ArrayList<Decoration> birthdayDecorations = cakeService.searchDecorationByCategoryAndName(key,"Birthday Decorations");
%>
